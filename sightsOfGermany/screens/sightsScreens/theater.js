...
const Theater = ({ navigation }) => {
    const sights = [
        {
            ...
            latitude: 51.513054031163854,
            longitude: 9.945454449783789
        },
        {
            id: 2,
            ...
            latitude: 48.86564938264127,
            longitude: 2.303186696815716
        },
    ];
    ...
    const setData = async () => {
        try {
            ...
            await AsyncStorage.setItem(`Theater`, jsonData);
    ...
    const getData = async () => {
        try {
            const jsonData = await AsyncStorage.getItem(`Theater`);
            if (jsonData !== null) {
