...
const Nightclub = ({ navigation }) => {
    ...
    const sights = [
        ...
        latitude: 52.51104948296727,
            longitude:   13.442994497046838
        },
        {
            id: 2,
        ...
        latitude: 48.86807358651411,
            longitude:  2.366325846954483
        },
    ];
    ...
    const setData = async () => {
        try {
            ...
            await AsyncStorage.setItem(`Nightclub`, jsonData);
    ...
    const getData = async () => {
        try {
            const jsonData = await AsyncStorage.getItem(`Nightclub`);
            if (jsonData !== null) {
