...
const Opera = ({ navigation }) => {
    ...
    const sights = [
        ...
        latitude: 51.054459195815475, 
            longitude: 13.735286925788659
        },
        {
            id: 2,
        ...
        latitude: 48.871920273411234,
            longitude: 2.3315692103091594
        },
    ];
    ...
    const setData = async () => {
        try {
            ...
            await AsyncStorage.setItem(`Opera`, jsonData);
    ...
    const getData = async () => {
        try {
            const jsonData = await AsyncStorage.getItem(`Opera`);
            if (jsonData !== null) {
