...
const ShoppingCenter = ({ navigation }) => {
    ...
    const sights = [
        {
            ...
            latitude: 52.50158247874509,
            longitude: 13.341014454717453
        },
        {
            id: 2,
            ...
            latitude: 45.76272923188091,
            longitude: 4.850183796628865
        },
    ];
    ...
    const setData = async () => {
        try {
            ...
            await AsyncStorage.setItem(`ShoppingCenter`, jsonData);
    ...
    const getData = async () => {
        try {
            const jsonData = await AsyncStorage.getItem(`ShoppingCenter`);
            if (jsonData !== null) {
